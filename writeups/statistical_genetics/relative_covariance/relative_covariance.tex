...
\begin{itemize}
    ...
    Note that the within-individual covariance $\Cov[\,x_{mk},\, x_{ml}\,]$ is still exactly zero for $k \neq l$: at this point the disequilibrium exists only \emph{between} the partners, not yet within either of them.
