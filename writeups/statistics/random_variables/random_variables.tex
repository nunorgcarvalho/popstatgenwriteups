...
Largely taken from the Wikipedia article on algebra of random variables \citep{wikipedia2026webAlgebraRandomVariables}. See below for definitions of covariance.
