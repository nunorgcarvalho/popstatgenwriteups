...
A commit here marks a **large, infrequent grouping of related edits**.
Getting the writeup into good shape takes many rounds of back-and-forth — you edit, Nuno revises,
you adjust — and none of those rounds is worth its own commit. Staging, not committing, is what
separates one round from the next.
...
edit, not because a section looks done to you. He decides when a grouping is worth marking and
says so explicitly. When he does ask:
